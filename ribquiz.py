...
def quiz6():
    ...
    while running:
        ...
        option1_button = Button.Button("", (255, 255, 255), pygame.font.SysFont("Helvetica", 20), 190,
                                       310, resized_button_image)

        option2_button = Button.Button("", (255, 255, 255), pygame.font.SysFont("Helvetica", 20), 190,
                                       410, resized_button_image)

        option3_button = Button.Button("", (255, 255, 255), pygame.font.SysFont("Helvetica", 20), 190,
