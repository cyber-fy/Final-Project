...
def throatanswer1():
    ...
    background = pygame.image.load('Images/throat slide 2.png').convert()
    backgroundsize = pygame.transform.scale(background, (1150, 700))
    pygame.display.set_caption("Throat Answer 1")
    ...
    while running:
        ...
        backtoheart_button = Button.Button("Back to Throat", (255, 255, 255), pygame.font.SysFont("Helvetica", 20), 800,
                                           600, pygame.image.load("Images/button.png"))
